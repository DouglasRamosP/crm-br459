  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-[280px] shrink-0 border-r border-white/60 bg-[#f8f3ea]/90 px-4 py-5 backdrop-blur lg:block">
      <div className="rounded-[24px] border border-white/80 bg-white/80 px-4 py-4 shadow-sm">
        <p className="text-[11px] font-semibold tracking-[0.28em] text-amber-700 uppercase">
          BR-459
        </p>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Negócio primeiro, produto depois.
        </p>
      </div>

      <div className="mt-6">
        <p className="px-2 text-[11px] font-semibold tracking-[0.24em] text-slate-400 uppercase">
          Módulos
        </p>
